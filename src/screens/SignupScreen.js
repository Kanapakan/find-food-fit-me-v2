    ...
    <Pressable className="flex-1" onPress={Keyboard.dismiss}>
      <SafeAreaView style={styles.container}>
        <ScrollView>
          ...
          <View className="items-center flex flex-col gap-5 mt-2">
            <Image
              style={styles.diet}
              source={require("../../assets/Diet.gif")}
            />
          </View>
          <View className="items-center mt-1" behavior="padding"> 
            <Input
          ...
          <View className="items-center flex mt-5">
            <Pressable
              ...
              title="SignUp" onPress={validate}
            >
              <Text className="text-lg text-white font-bold" style={styles.btnText}>Sign Up</Text>
            </Pressable>
          </View>
